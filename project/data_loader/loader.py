...
def load_dataset(file_path: str) -> MicrowaveDataset:
    """
    Purpose:
    ...
    if ext == ".mat":
        return load_matlab_dataset(file_path)
...
def load_dataset_with_summary(file_path: str) -> tuple[MicrowaveDataset, DatasetSummary]:
    """
    Purpose:
        Convenience wrapper used directly by the GUI: loads a dataset and
